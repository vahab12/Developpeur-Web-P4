    ...
    function n(n, D) {
            ...
            if (xe !== E && xe !== m && !B()) {
                ...
                if (De = le(), b && (Se = b.length), D.hold && clearTimeout(Ae), xe = y, 2 == Se && (0 == we ? (K(1, b[1]), we = ve = ie(Oe[0].start, Oe[1].start)) : ($(b[1]), ve = ie(Oe[0].end, Oe[1].end), Oe[0].end, Oe[1].end, ye = Te < 1 ? a : o), Te = (ve / we * 1).toFixed(2), be = Math.abs(we - ve)), Se === D.fingers || D.fingers === v || !b || C()) {
                    if (de = re(x.start, x.end), function(e, n) {
                        ...
                        }(n, fe = re(x.last, x.end)), h = x.start, d = x.end, he = Math.round(Math.sqrt(Math.pow(d.x - h.x, 2) + Math.pow(d.y - h.y, 2))), ge = te(), function(e, n) { e != u && (n = Math.max(n, ee(e)), Ee[e].distance = n) }(de, he), T = j(f, xe), !D.triggerOnTouchEnd || D.triggerOnTouchLeave) {
                        var S = !0;
                        if (D.triggerOnTouchLeave) {
                            var O = { left: (p = (c = e(c = this)).offset()).left, right: p.left + c.outerWidth(), top: p.top, bottom: p.top + c.outerHeight() };
                            S = function(e, n) { return e.x > n.left && e.x < n.right && e.y > n.top && e.y < n.bottom }(x.end, O)
        ...
        function R(e) {
            var n = e.originalEvent ? e.originalEvent : e,
                t = n.touches;
            if (t) { if (t.length && !B()) return function(e) { Pe = le(), Le = e.touches.length + 1 }(n), !0; if (t.length && B()) return !0 }
        ...
        function k() { Se = 0, De = 0, Me = 0, we = 0, ve = 0, Te = 1, Z(), J(!1) }
        ...
        function I() { me.unbind(ae, P), me.unbind(pe, k), me.unbind(ue, L), me.unbind(se, R), ce && me.unbind(ce, A), J(!1) }
        ...
        function j(e, n) { var t, i = e.touches; return (!(!F() || !X()) || X()) && (t = N(e, n, c)), (!(!Q() || !C()) || C()) && !1 !== t && (t = N(e, n, p)), G() && z() && !1 !== t ? t = N(e, n, d) : ge > D.longTapThreshold && he < T && D.longTap && !1 !== t ? t = N(e, n, f) : !(1 !== Se && x || !(isNaN(he) || he < D.threshold) || !W()) && !1 !== t && (t = N(e, n, h)), n === m && k(), n === E && (i && i.length || k()), t }
        ...
        function N(n, u, s) {
            ...
            return s == h ? u !== m && u !== E || (clearTimeout(ke), clearTimeout(Ae), z() && !G() ? (Re = le(), ke = setTimeout(e.proxy(function() { Re = null, me.trigger("tap", [n.target]), D.tap && (g = D.tap.call(me, n, n.target)) }, this), D.doubleTapThreshold)) : (Re = null, me.trigger("tap", [n.target]), D.tap && (g = D.tap.call(me, n, n.target)))) : s == d ? u !== m && u !== E || (clearTimeout(ke), clearTimeout(Ae), Re = null, me.trigger("doubletap", [n.target]), D.doubleTap && (g = D.doubleTap.call(me, n, n.target))) : s == f && (u !== m && u !== E || (clearTimeout(ke), Re = null, me.trigger("longtap", [n.target]), D.longTap && (g = D.longTap.call(me, n, n.target)))), g
        }

        function H() { var e = !0; return null !== D.threshold && (e = he >= D.threshold), e }

        function _() { var e = !1; return null !== D.cancelThreshold && null !== de && (e = ee(de) - he >= D.cancelThreshold), e }

        function q() { return !(D.maxTimeThreshold && ge >= D.maxTimeThreshold) }
        ...
        function C() { return !!(D.pinchStatus || D.pinchIn || D.pinchOut) }
        ...
        function X() { return !!(D.swipe || D.swipeStatus || D.swipeLeft || D.swipeRight || D.swipeUp || D.swipeDown) }

        function Y() { return Se === D.fingers || D.fingers === v || !x }

        function V() { return 0 !== Oe[0].end.x }

        function W() { return !!D.tap }

        function z() { return !!D.doubleTap }

        function G() { if (null == Re) return !1; var e = le(); return z() && e - Re <= D.doubleTapThreshold }
        ...
        function J(e) { me && (!0 === e ? (me.bind(ue, L), me.bind(se, R), ce && me.bind(ce, A)) : (me.unbind(ue, L, !1), me.unbind(se, R, !1), ce && me.unbind(ce, A, !1)), me.data(M + "_intouch", !0 === e)) }

        function K(e, n) { var t = { start: { x: 0, y: 0 }, last: { x: 0, y: 0 }, end: { x: 0, y: 0 } }; return t.start.x = t.last.x = t.end.x = n.pageX || n.clientX, t.start.y = t.last.y = t.end.y = n.pageY || n.clientY, Oe[e] = t, t }

        function $(e) {
            var n = void 0 !== e.identifier ? e.identifier : 0,
                t = function(e) { return Oe[e] || null }(n);
            return null === t && (t = K(n, e)), t.last.x = t.end.x, t.last.y = t.end.y, t.end.x = e.pageX || e.clientX, t.end.y = e.pageY || e.clientY, t
        }

        function ee(e) { if (Ee[e]) return Ee[e].distance }

        function ne(e) { return { direction: e, distance: 0 } }

        function te() { return De - Me }
        ...
        function le() { return (new Date).getTime() }
        D = e.extend({}, D);
        var oe = x || O || !D.fallbackToMouseEvents,
            ...
            ke = null,
            Ae = null;
        try { me.bind(ae, P), me.bind(pe, k) } catch (n) { e.error("events not supported " + ae + "," + pe + " on jQuery.swipe") }
        this.enable = function() { return this.disable(), me.bind(ae, P), me.bind(pe, k), me }, this.disable = function() { return I(), me }, this.destroy = function() { I(), me.data(M, null), me = null }, this.option = function(n, t) {
